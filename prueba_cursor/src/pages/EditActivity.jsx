...
// Función para normalizar strings sin tildes y en minúsculas
const normalize = (str) =>
...
const EditActivity = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      titulo: form.titulo,
      dia: diasValidos.find(d => normalize(d) === normalize(form.dia)), // Siempre enviar la versión bien escrita
